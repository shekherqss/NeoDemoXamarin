...
{
    public class FillDetailsTypeDance : ContentPage
    {
        /// <summary>
        ...
        /// </summary>
        public IUIUtility<FillDetailsTypeDanceViewModelSharp> viewUtility;
        ...
        {
            var _viewUtility = AppContainer.Resolve<IUIUtility<FillDetailsTypeDanceViewModelSharp>>();
        ...
        public void LoadPageSettings()
        {
            if (_isInitialLoad)
            {
                ...
                (BindingContext as FillDetailsTypeDanceViewModelSharp).LoadData();
                while (template == null)
                {
