...
{
    public class FillDetailsTypeMusicViewModelSharp : BaseViewModel, INotifyPropertyChanged
    {
        public FillDetailsTypeMusicViewModelSharp()
        {
        }
        ...
        private string _serializedJson = CoreConstants.DefaultSerializedJsonMusic;
